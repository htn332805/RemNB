...
#if 0
#define CONNSAT_TRACE printf("CTRACE: %s-%d%s", __FILE__, __LINE__, newline_string_p)
#else
#define CONNSAT_TRACE 
#endif

#if 0
#define CONNSAT_CLIENT_TRACE printf("CTRACE: %s-%d%s", __FILE__, __LINE__, newline_string_p)
#else
#define CONNSAT_CLIENT_TRACE 
#endif

#if 0
#define CONNSAT_TRACE_DUMP printf("CTD_TRACE: %s-%d%s", __FILE__, __LINE__, newline_string_p); \
